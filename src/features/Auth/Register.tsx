				...
				<div className="bg-background/80 animate-fade-in-up flex w-full max-w-3xl flex-col items-stretch gap-0 overflow-hidden rounded-md shadow-lg md:flex-row md:gap-0">
					<div className="bg-background flex flex-1 items-center justify-center p-8">
						<Card className="w-full max-w-md border-none bg-transparent p-0 shadow-none">
							<CardHeader>
								<CardTitle className="w-full text-center text-2xl">Register</CardTitle>
							</CardHeader>
							<CardContent>
								<form onSubmit={handleSubmit(onSubmit)} className="space-y-5" autoComplete="on">
										...
										<DropdownMenu>
											...
											<DropdownMenuContent className="w-full min-w-[8rem]">
												...
												<DropdownMenuCheckboxItem
													...
													onCheckedChange={() => handleRoleChange("futsalOwner")}
												>
													Futsal Owner
												</DropdownMenuCheckboxItem>
											</DropdownMenuContent>
									...
									<div className="pt-2 text-center">
										<a href="/login" className="text-muted-foreground text-sm hover:underline">
											Registered User? <span className="text-primary font-semibold">Login</span>
										</a>
									</div>
								</form>
							</CardContent>
